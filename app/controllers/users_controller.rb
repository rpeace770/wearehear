...
class UsersController < ApplicationController
  ...
  def show
    ...
    tracks = RestClient.post("https://api.spotify.com/v1/users/#{current_user.uid}/playlists/#{current_user.playlist}/tracks", {"uris": tracks_array}.to_json, {"Authorization": "Bearer #{current_user.token}","Content-Type": "application/json"})
